...
public interface GatheringUserApiDocs {
    ...
    void applyGathering(@Parameter(hidden = true) Long userId, Long gatheringId);
    ...
    ApplicantUserDto getApplicantsInGatheringByHost(@Parameter(hidden = true) Long userId, Long gatheringId);
    ...
    void patchApplicantStatusByHost(@Parameter(hidden = true) Long userId,
                                    Long applicantId,
